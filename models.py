...
#   2. Alert — Simplified LLM-friendly alert (Prometheus Alertmanager-inspired)
...
class ServiceMetrics(BaseModel):
    ...
    runtime_gc_pause_duration_ms: float = Field(
        ...
        description=(
            ...
            "guideline — chosen for human-readable prompt output). "
    ...
    runtime_gc_count_per_second: float = Field(
        ...
        description=(
            ...
            "Unit: {gc}/s. Not a standard OTel metric — computed from "
...
class Alert(BaseModel):
    ...
    Deliberately flat — real Alertmanager nests {alertname, severity} under
